...
<div id="form" class="container-fluid"  style="position: relative;
	...
	VOCÊ NÃO ESTA CADASTRADO NA NOSSA BASE DE DADOS PARA INCLUIR UM PRODUTO À VENDA.
	
</div></div>
<div><a href="index.html"><button>Voltar para tela Inicial.</button></a></div>
<div><a href="prod_reg.php"><button>Voltar para tela de Cadastro.</button></a></div>
